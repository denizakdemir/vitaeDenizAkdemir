...
Deniz Akdemir is a statistician with advanced expertise in statistical modeling, experimental design, and data analysis. His career spans academic research and applied statistics across healthcare, finance, and genomics, where he leverages quantitative methods to derive actionable insights from complex data.
...
- **Senior Clinical Data Scientist**, National Marrow Donor Program (2023 - Current)  
  Lead statistical analysis and design of clinical trials, improving study efficiency and decision-making.
- **Clinical Data Scientist**, National Marrow Donor Program (2021 - 2023)  
  Developed predictive models and data-driven insights to optimize business strategies.
- **Postdoctoral Research Associate**, University College Dublin (2019 - 2021)  
  Conducted research in innovative statistical methodologies and contributed to high-impact publications.
...
His research focuses on the development and application of robust statistical methods, including Bayesian modeling, time series analysis, and nonparametric techniques, to solve real-world challenges in various domains.
